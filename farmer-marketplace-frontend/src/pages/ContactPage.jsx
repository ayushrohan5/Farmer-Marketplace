    ...
    <section className="min-h-screen bg-green-50 py-16 px-6 md:px-20">
      ...
      >
        ...
        <p className="text-green-700 text-center mb-8">
          We would love to hear from you. Drop your message and we will get back
          shortly.
        </p>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-green-600 cursor-pointer text-white py-3 rounded-lg hover:bg-green-700 transition"
          >
            Send Message
          </button>
        </form>
