...
const ProductList = ({ products }) => {
  ...
  return (
    <div className="min-h-screen animate-gradient bg-[linear-gradient(-45deg,#d4f5d4,#e6ffe6,#ccf2cc,#f0fff0)] bg-[length:400%_400%] p-6 transition-all duration-1000 ease-in-out">
