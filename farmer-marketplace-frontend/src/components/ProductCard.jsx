...
const ProductCard = ({ product }) => {
  ...
  return (
    <motion.div
      ...
      className="cursor-pointer backdrop-blur-lg bg-white/20 border border-white/30 rounded-xl shadow-md p-4 w-60 mx-1 transition-all duration-300 hover:shadow-xl"
    >
      <img
        src={product.image}
        alt={product.name}
